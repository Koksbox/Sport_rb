    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('M', 'Мужской'), ('F', 'Женский')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('role', models.CharField(choices=[('athlete', 'Спортсмен'), ('parent', 'Родитель'), ('coach', 'Тренер'), ('director', 'Директор'), ('committee_staff', 'Сотрудник горкомспорта'), ('admin_rb', 'Админ РБ')], max_length=20)),
                ('is_active', models.BooleanField(default=True)),
